...
const items = [
  {
    quote:
      "Trabalhar com a Aftersale com o software Troque Fácil foi um grande passo na automação da operação de e-commerce Tramontina Store.",
    name: "Marceli Oliani",
        ...
        <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-6">
          {items.map((t, i) => (
            <motion.figure
              ...
              className="relative rounded-3xl border border-border bg-card p-8 lg:p-10 shadow-card hover:shadow-brand hover:border-brand/30 transition-all"
            >
              ...
              <figcaption className="mt-8 pt-6 border-t border-border">
                ...
                <div className="text-sm font-semibold text-brand mt-1">{t.company}</div>
              </figcaption>
            </motion.figure>
          ))}
        </div>
