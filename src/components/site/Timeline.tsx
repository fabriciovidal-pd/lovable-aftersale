...
const milestones = [
  { year: "2017–18", title: "O começo", desc: "Nascemos como empresa de pontos de entrega e criamos o produto de troca e devolução." },
  { year: "2019–20", title: "Vale do Silício", desc: "Única empresa brasileira aceita no programa 500 Startups no Vale do Silício." },
  { year: "2021–22", title: "Ecossistema Confi", desc: "A soma de experiências consolida. Nos tornamos parte do ecossistema Confi." },
  { year: "2023+", title: "Liderança consolidada", desc: "+400 clientes, +6M reversas. Líderes consolidados no mercado de troca e devolução." },
  { year: "2025", title: "Reposicionamento tecnológico", desc: "Reestruturação e reposicionamento tecnológico do produto, orientado a dados e governança." },
];

export function Timeline() {
  return (
    <section id="rp" className="py-24 lg:py-32 bg-surface">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="relative mt-20">
          ...
          <div className="space-y-12 md:space-y-20">
            ...
            >
              <span className="absolute left-4 md:left-1/2 top-6 size-4 rounded-full bg-accent ring-4 ring-surface md:-translate-x-1/2 shadow-glow" aria-hidden />
              <div className="md:col-span-12">
                <div className="relative overflow-hidden rounded-3xl border border-brand/20 bg-brand-gradient p-10 lg:p-14 shadow-brand-strong">
                  <div className="absolute -top-24 -right-24 size-72 rounded-full bg-accent opacity-20 blur-3xl" aria-hidden />
                  <div className="relative">
                    <div className="inline-flex items-center gap-2 rounded-full border border-brand-foreground/20 bg-brand-foreground/10 backdrop-blur px-3 py-1 text-xs text-brand-foreground">
